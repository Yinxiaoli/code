...
%  response=jsonrpc_request_save_model(host, port, filename, cachename, saveCacheFull)   
...
%     cachename: the name of the file to save additional learning cache
%                data, for resuming training
