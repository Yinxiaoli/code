...
typedef struct {
  ...
  time_t timestamp_start;  /**< a timestamp when this session was first started */
...
public:
  ...
  StructuredSVM *GetLearner() { return learner; }
...
<font color="red">Server:</font> {"id":1,"session_id":"session_id"}
  ...
  virtual bool GetTrainset(const Json::Value& root, Json::Value& response);

  virtual bool RemoveExample(const Json::Value& root, Json::Value& response);
...
/// @cond
 protected:
  ...
  void EvictSession(int ind=-1, Session *replace=NULL);
