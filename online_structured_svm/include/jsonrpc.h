 ...
 */
Json::Value JsonRpcClientRequest(const char *hostname, int port, Json::Value &req, bool debug=false);


char *http_request(const char *host, const char *remote_file, int *err, const char *request_type="GET", const char *type="url",
                  const char *post_parameters=NULL, int postSz=0, const char *host_referer=NULL,
                  const char *referer=NULL, const char *cookie=NULL, bool getHeader=false, int *sz=NULL);
