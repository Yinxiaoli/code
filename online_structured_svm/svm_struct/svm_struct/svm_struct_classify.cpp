...
void read_input_parameters_classify(int, char **, char *, char *, char *, 
...
int main_classify(int argc, char* argv[])
{
  ...
  read_input_parameters_classify(argc,argv,testfile,modelfile,predictionsfile,&sparm,
...
void read_input_parameters_classify(int argc,char *argv[],char *testfile,
			   ...
			   long *verbosity,long *struct_verbosity)
{
  ...
  for(i=1;(i<argc) && ((argv[i])[0] == '-');i++) {
    switch ((argv[i])[1]) 
      ...
      case '?': print_help_classify(); exit(0);
