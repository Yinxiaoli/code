...
void   read_input_parameters_train(int, char **, char *, char *,long *, long *,
...
{  
  ...
  read_input_parameters_train(argc,argv,trainfile,modelfile,&verbosity,
...
void read_input_parameters_train(int argc,char *argv[],char *trainfile,
			   char *modelfile,
			   ...
			   int *alg_type)
{
  ...
  struct_parm->modelfile = modelfile;
  struct_parm->learner = NULL;
